...
RSpec.describe User, type: :model do
  ...
  it 'last_three_posts returns the last three posts' do
    @post = Post.new(author: @user, title: 'Hello', text: 'This is my first post', comments_counter: 0,
                     likes_counter: 0)
    @post.save
    @post = Post.new(author: @user, title: 'Hello2', text: 'This is my first post', comments_counter: 0,
                     likes_counter: 0)
    @post.save
    @post = Post.new(author: @user, title: 'Hello3', text: 'This is my first post', comments_counter: 0,
                     likes_counter: 0)
    @post.save
    @post = Post.new(author: @user, title: 'Hello4', text: 'This is my first post', comments_counter: 0,
                     likes_counter: 0)
    @post.save
