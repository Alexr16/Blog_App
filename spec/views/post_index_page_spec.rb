...
RSpec.describe 'User index page', type: :system do
  describe 'index page' do
    before :each do
      ...
      @post = @jorge.posts.create(title: 'Test', text: 'This is the Posts page.', author_id: @jorge.id)
      @comment = Comment.new(author: @jorge, post: @post, text: 'This is my first comment')
      @comment.save
